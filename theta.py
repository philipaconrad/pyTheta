...
p_H2    = mpf('1.0')          #H2
p_M     = mpf('1.0e-5')       #catechol
p_S     = mpf('1.0e-5')       #phenol
p_X     = mpf('1.0e-5')       #benzene
p_K     = mpf('1.0e-5')       #anisole
p_CO    = mpf('1.0e-6')
p_H2O   = mpf('0.0')
p_CH4   = mpf('0.0')
p_CH3OH = mpf('0.0')
...
#Unknown quantities, our thetas:
"""theta_A     = initialState[0]
theta_E     = initialState[1]
theta_F     = initialState[2]
theta_G     = initialState[3]
theta_I     = initialState[4]
theta_L     = initialState[5]
theta_M     = initialState[6]
theta_N     = initialState[7]
theta_O     = initialState[8]
theta_R     = initialState[9]
theta_S     = initialState[10]
theta_U     = initialState[11]
theta_V     = initialState[12]
theta_X     = initialState[13]
free        = initialState[14]
theta_H     = initialState[15]
theta_OH    = initialState[16]
theta_H2O   = initialState[17]
theta_CH    = initialState[18]
theta_CH2   = initialState[19]
theta_CH3   = initialState[20]
theta_CH4   = initialState[21]
theta_CHO   = initialState[22]
theta_CH2O  = initialState[23]
theta_CH3O  = initialState[24]
theta_CH3OH = initialState[25]
theta_W     = initialState[26]
theta_T     = initialState[27]
theta_B     = initialState[28]
theta_J     = initialState[29]
theta_P     = initialState[30]
theta_C     = initialState[31]
theta_D     = initialState[32]
theta_K     = initialState[33]
theta_Q     = initialState[34]
theta_Y     = initialState[35]
theta_Z     = initialState[36]
theta_Z1    = initialState[37]
theta_CO    = initialState[38]"""
...
if __name__ == '__main__':
    ...
    def coverage(theta_A,
        ...
        forwardRates = [
            ...
            lambda : k_b[38]*0,                         #need proper formula for #38.
        ...
        steadyStateApprox = [
	        ...
	        lambda r: r[04] + r[17] + r[47] - r[41],            # d(theta_CH3O)/dt=0
    ...
    #NLSystem = findroot([coverage] + constraints, initialState, solver='mnewton', verbose=True)
    NLSystem = findroot(coverage, initialState, solver='mnewton', verbose=True)
